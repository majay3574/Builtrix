...
export class SalesforceAccountPage extends PageCore {
  ...
  public async ratingDropdown(data: string) {
    ...
    await this.click(
      selectors.accounts.dropdownValueSelector(data),
      data,
      "Button"
    );
  }
  ...
  public async accountNumber(data: string) {
    await this.type(
      selectors.accounts.accountNumberInput,
      "Account Number",
      data
    );
  }
  ...
  public async billingStreet(data: string) {
    await this.type(
      selectors.accounts.billingStreetInput,
      "Billing Street",
      data
    );
  }
  ...
  public async billingState(value: string) {
    await this.type(
      selectors.accounts.billingStateInput,
      "Billing State",
      value
    );
  }
  ...
  public async billingCountry(value: string) {
    await this.type(
      selectors.accounts.billingCountryInput,
      "Billing Country",
      value
    );
  }
  ...
  public async verifiAccountName(value: string) {
    ...
    await this.validateElementVisibility(
      selectors.accounts.verificationText,
      "Account Name"
    );
    const accountName = await this.getInnerText(
      selectors.accounts.verificationText
    );
  ...
  public async searchAccount(accountName: string) {
    await this.interactWithElement(
      "PLACEHOLDER",
      selectors.accounts.Searchthis,
      "fill",
      accountName
    );
    await this.keyboardAction(
      `[placeholder="${selectors.accounts.Searchthis}"]`,
      "Enter",
      "Input",
      "Search This"
    );
